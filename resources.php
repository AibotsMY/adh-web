      ...
      <div class="row row-height" id="featured_section">
        ...
        <div class="col-xs-18 col-sm-5 col-md-5" style="background:#0F122B;">
          <div id="about-text">
            ...
            <a href="resources-inside.php" class="btn btn-info btn-xs mt-4" role="button">READ MORE</a>
          </div>
          <!-- end about text-->
  ...
  <script>
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        feature_section.find('a').attr('href', 'resources-inside.php?id=' + feature_blog.id);
        ...
        blogs.forEach((blog) => {
          console.log(blog)
          let blog_html = `
          <a href="/resources-inside.php?id=${blog.id}" class="col-xs-18 col-sm-6 col-md-4">
            <div class="thumbnail">
