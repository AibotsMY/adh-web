...
<div class="group-data-[sidebar-size=sm]:min-h-sm group-data-[sidebar-size=sm]:relative">
    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <?php //includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'SubScriber User', 'title' => 'SubScriber User')); 
            ?>

            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Subscriber</h5>
                    <p>Overiview, <strong>subscriber user</strong></p>
                </div>
                ...
                <div class="ltr:md:text-end rtl:md:text-start">
                    <button type="button" data-modal-target="showModal" data-bs-toggle="static-modal"
                        ...
                        data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i
                            class="align-bottom ri-add-line me-1"></i> Add New User</button>
            ...
            <div class="card" id="customerList">
                <div class="card-body">
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        <div class="grid grid-cols-2 gap-1 mb-5 xl:grid-cols-2" style="width:64%;">
                            <div class="relative">
                        ...
                        <div class="grid grid-cols-2 gap-1 mb-2 xl:grid-cols-2">
                            ...
                            <div class="relative">
                                <button type="button"
                                    ...
                                    <i class="align-bottom ri-list-unordered"></i> Custormize Layout</button>
                            </div>
                            <div class="relative">
                        ...
                        <table class="w-full whitespace-nowrap" id="customerTable">
                            <thead class="bg-slate-100 dark:bg-zink-600">
                                <tr>
                                    ...
                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                        data-sort="phone">Subscription Plan Name</th>
                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                        data-sort="date">Subs Start Date</th>
                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                        data-sort="date">Subs End Date</th>
                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                        data-sort="status">Status</th>
                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                        data-sort="status">Payment Status</th>
                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                        data-sort="status">Billing Amount</th>
                                    <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 ltr:text-left rtl:text-right"
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                        <div class="icon"><span data-v-0ff4fc29="" class="reference"><a
                                                    data-bs-target="#showModal" href="javascript:void(0)"
                                                    data-modal-target="showModal" data-bs-toggle="static-modal"
                                                    data-v-e087307f="" class="icon-button confetti-button vp-raw"
                                                    aria-label="ellipsis-vertical" data-confetti-text="confetti!"><svg
                                                        data-v-e087307f="" xmlns="http://www.w3.org/2000/svg" width="24"
...
<div id="showModal" modal-center
    ...
    <div class="w-screen md:w-[40rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zink-500">
            <h5 class="text-16" id="exampleModalLabel">Add New Subscription Plan
                <p style="font-weight: normal;
    font-size: 13px;"><span>Make modification onto the
                        plan</span></p>
            </h5><br />
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
            <form class="tablelist-form">
                ...
                <div class="mb-3">
                    <label for="customername-field" class="inline-block mb-2 text-base font-medium">Subscription Name
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-3">
                        <label for="status-field" class="inline-block mb-2 text-base font-medium">Subscription Icon
                            <span class="text-red-500">*</span></label>
                        <select
                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                    ...
                    <div class="mb-3">
                        <label for="status-field" class="inline-block mb-2 text-base font-medium">Subscription Monthly
                            Amount (SGD) <span class="text-red-500">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="status-field" class="inline-block mb-2 text-base font-medium">Subscription Annuval
                            Amount (SGD)
                            <span class="text-red-500">*</span></label>
                        <div class="flex items-center">
                            <span
                ...
                <div class="mb-3">
                    <label for="email-field" class="inline-block mb-2 text-base font-medium">Subscription Special Label
                        <span class="text-red-500">*</span></label>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="ltr:text-left rtl:text-right ">
                                <tr>
                                    <th
                                        class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">
                                        Plan Benefits </th>
                                    <th
                                        class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">
                                        Include</th>
                            ...
                            <tbody class="">
                                <tr>
                                    <td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">Benefits
                                    </td>
                                    <td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500"><label
                                            for="checkboxSoft3" class="align-middle">
                                            Orange
                                        </label></td>
                                    <td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500"><label
                                            for="checkboxSoft3" class="align-middle">
