...
<head>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Admin Designation')); ?>
...
<div class="group-data-[sidebar-size=sm]:min-h-sm group-data-[sidebar-size=sm]:relative">
    ...
    <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <?php // includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Admin Designation', 'title' => 'Admin Designation')); 
            ?>

            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Designation</h5>
                    <p>Overiview, <strong>designation</strong></p>
                </div>
                ...
                <div class="ltr:md:text-end rtl:md:text-start">
                    <button type="button" data-modal-target="showModal" data-bs-toggle="static-modal"
                        ...
                        id="create-btn" data-bs-target="#showModal"><i class="align-bottom ri-add-line me-1"></i>
                        Add
                        Designation</button>
                ...
                <div class="card-body">
                    ...
                    <div class="flex items-center gap-5 mb-4">
                        <div class="grid grid-cols-3 gap-1 mb-5 xl:grid-cols-2" style="width:64%;">
                            <div class="relative">
                                <strong>Admin Designation List</strong>
                            </div>
                            <div class="relative">
                        ...
                        <div class="grid grid-cols-2 gap-1 mb-2 xl:grid-cols-2">
                            ...
                            <div class="relative" style="width: 200%;">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Search for designation" autocomplete=" off">
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                        <div class="icon"><span data-v-0ff4fc29="" class="reference"><a
                                                    ...
                                                    aria-label="ellipsis-vertical" href="/icons/ellipsis-vertical"
                                            ...
                                            <div data-v-0ff4fc29="" class="tooltip"
                                                style="position: absolute; left: -23px; top: 52px;">
                                                ellipsis-vertical
                                            </div>
                                        </div>
                                    </td>
...
<div id="showModal" modal-center
    ...
    <div class="w-screen md:w-[40rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zink-500">
            <h5 class="text-16" id="exampleModalLabel">Add Designation
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
            <form class="tablelist-form">
                ...
                <div class="mb-3">
                    <label for="customername-field" class="inline-block mb-2 text-base font-medium">Designation Name
