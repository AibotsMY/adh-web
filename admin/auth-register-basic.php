        ...
        <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
            <div class="!px-10 !py-12 card-body">
                ...
                <div class="mt-8 text-center">
                    ...
                    <p class="text-slate-500 dark:text-zink-200">Get your free Asiadealhub account now</p>
                </div>
                ...
                <form action="#!" class="mt-10" id="registerForm">
                    ...
                    <p class="italic text-15 text-slate-500 dark:text-zink-200">By Signing Up, I agree with Asiadealhub
                    ...
                    <div class="">
                        ...
                        <button
                            class="flex w-full mb-3 justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md  px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
