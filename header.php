<header id="masthead" class="masthead--transparent">
    ...
    <!-- Large screen logo -->
            ...
            <!-- Small screen logo -->
            <a class="navbar-brand res-logo" href="index.php" style="padding:5px 0px 15px 5px;display: none;">
          ...
          <ul id="menu-header-main" class="header-menu header-menu-primary">
              ...
              <div class="header-sub-menu sm-menu">
                ...
                <ul class="header-sub-menu-column">
                  <li class="header-menu-item header-menu-item-29577 menu-item-depth--1 header-menu-item--has-children">
                    ...
                    <li class="header-menu-item header-menu-item-191 menu-item-depth--1">
                      <a href="offering-research.php" class="header-menu-link">
                        <span>Research</span>
                      </a>
                      <!---->
                    </li>
                    <li class="header-menu-item header-menu-item-21544 menu-item-depth--1">
                      <a href="offering-strategy.php" class="header-menu-link">
                        <span>Strategy</span>
                      </a>
                      <!---->
                    </li>
                    <li class="header-menu-item header-menu-item-2406 menu-item-depth--1">
                      <a href="offering-operation.php" class="header-menu-link">
                        <span>Operation</span>
                      </a>
                      <!---->
                    </li>
                    <li class="header-menu-item header-menu-item-2406 menu-item-depth--1">
                      <a href="offering-digital.php" class="header-menu-link">
                        <span>Digital</span>
                      </a>
                      <!---->
                    </li>
                  ...
                  <li class="header-menu-item header-menu-item-29578 menu-item-depth--1 header-menu-item--has-children">
                    ...
                    <ul class="header-sub-menu-column">
                      <li class="header-menu-item header-menu-item-194 menu-item-depth--2">
                        <a href="offering-develop.php" class="header-menu-link">
                          <span>Research & Development</span>
                        </a>
                      </li>
                      <li class="header-menu-item header-menu-item-197 menu-item-depth--2">
                        <a href="marketing.php" class="header-menu-link">
                          <span>Marketing</span>
                        </a>
                      </li>
                      <li class="header-menu-item header-menu-item-31870 menu-item-depth--2">
                        <a href="merger.php" class="header-menu-link">
                          <span>Merger & Acquisition</span>
                        </a>
                      </li>
                      <li class="header-menu-item header-menu-item-31870 menu-item-depth--2">
                        <a href="procurement.php" class="header-menu-link">
                  ...
                  <li class="header-menu-item header-menu-item-29579 menu-item-depth--1 header-menu-item--has-children">
                    ...
                    <ul class="header-sub-menu-column">
                      <li class="header-menu-item header-menu-item-671 menu-item-depth--2">
                        <a href="commodity.php" class="header-menu-link">
                          <span>Commodity</span>
                        </a>
                      </li>                      
                    </ul>
                ...
                <ul class="header-sub-menu-column">
                  <li class="header-menu-item header-menu-item-29579 menu-item-depth--1 header-menu-item--has-children">
                    ...
                    <ul class="header-sub-menu-column">
                      <li class="header-menu-item header-menu-item-671 menu-item-depth--2">
                        <a href="service.php" class="header-menu-link">
                          <span> Sourcing As A Service</span>
                        </a>
                      </li> 
                      <li class="header-menu-item header-menu-item-671 menu-item-depth--2">
                        <a href="intelligence-marketplace.php" class="header-menu-link">
            ...
            <li class="header-menu-item header-menu-item-151 menu-item-depth--0">
              <a href="expert.php" id="menuh" class="header-menu-link">
                <span>EXPERT</span>
              </a>
              <!---->
              <!---->
            ...
            <li class="dmenu header-menu-item header-menu-item-5778 menu-item-depth--0 header-menu-item--has-children">
              ...
              <div class="header-sub-menu sm-menu">
                <ul class="header-sub-menu-column">
                  <li class="header-menu-item header-menu-item-29579 menu-item-depth--1 header-menu-item--has-children">
                    ...
                    <ul class="header-sub-menu-column">
                      ...
                      <li class="header-menu-item header-menu-item-671 menu-item-depth--2">
                        <a href="team.php" class="header-menu-link">
                          <span> Team</span>
                        </a>
                      </li>          
                      <li class="header-menu-item header-menu-item-671 menu-item-depth--2">
                ...
                <ul class="header-sub-menu-column">
                  ...
                  <li class="header-menu-item header-menu-item-671 menu-item-depth--2">
                    <a href="career.php" class="header-menu-link">
                      <span> Career</span>
                    </a>
                  </li>          
              ...
              <div class="header-sub-menu sm-menu1">
                <ul class="header-sub-menu-column">
                  <li class="header-menu-item menu-item-depth--1">
                    <a href="" class="header-menu-link lang-en current-language">
                      <span>English</span>
                    </a>
                  </li>
                  <li class="header-menu-item menu-item-depth--1">
                    <a href="" class="header-menu-link lang-zh-hans">
                      <span>简体中文</span>
                    </a>
                  </li>
                  <li class="header-menu-item menu-item-depth--1">
                    <a href="" class="header-menu-link lang-ja">
                      <span>日本語</span>
                    </a>
                  </li>
                </ul>
                <ul class="header-sub-menu-column">
                  <li class="header-menu-item menu-item-depth--1">
                    <a href="" class="header-menu-link lang-ko">
                      <span>한국어</span>
                    </a>
                  </li>
                  <li class="header-menu-item menu-item-depth--1">
                    <a href="" class="header-menu-link lang-de">
                      <span>Deutsch</span>
                    </a>
                  </li>
                </ul>
