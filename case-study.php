...
<?php include('header.php'); ?>
  ...
  #181015 url(assets/images/banner13.webp) no-repeat;background-size: cover;">
    <div class="container">
      <div class="heading">
        <h1 style="font-family:Inter">
          Real-World Success <br>Stories</h1>
        <p style="color:white">
          Case studies are an excellent example of how a small<br>
           business can successfully provide financial services to<br> its customers.
        </p>
        <br />
...
<h2>Featured Blog</h2>
<p style="margin-bottom:20px"> Inspiring Stories of Expert Success</p>
<div class="row row-height">
  ...
  <div class="col-xs-18 col-sm-4 col-md-4"  style="background:#0F122B;">
    <div id="about-text">
      <h6 style="color:#DC1010">CASE STUDY</h6>
      <h4 style="color:white">Leveraged Customer Feedback for Improved Services</h4>
      <p style="color:white">
        Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety..</p>
      <a href="case-study-inside.php" class="btn btn-info btn-xs" role="button">READ MORE</a>
  ...
  <input type="text" placeholder="Search..." class="search-input"> 
    ...
    <div class="row">
      ...
      <div class="col-xs-18 col-sm-6 col-md-4">
        <div class="thumbnail">
          <img src="assets/images/g1.png" style="height:200px;width:100%;">
          <div class="caption">
            <p style="color:#DC1010;font-size:10px">CASE STUDY</p>
      ...
      <div class="col-xs-18 col-sm-6 col-md-4">
        <div class="thumbnail">
          <img src="assets/images/g2.jpg" style="height:200px;width:100%;">
          <div class="caption">
            <p style="color:#DC1010;font-size:10px">CASE STUDY</p>
            <h4>Leveraged Customer Feedback for Improved Services</h4>
            <p>Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety...
      ...
      <div class="col-xs-18 col-sm-6 col-md-4">
        <div class="thumbnail">
          <img src="assets/images/g3.png" style="height:200px;width:100%;">
          <div class="caption">
            <p style="color:#DC1010;font-size:10px">CASE STUDY</p>
            <h4>Leveraged Customer Feedback for Improved Services</h4>
            <p>Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety...
      ...
      <div class="col-xs-18 col-sm-6 col-md-4">
        <div class="thumbnail">
          <img src="assets/images/g4.png" style="height:200px;width:100%;">
          <div class="caption">
            <p style="color:#DC1010;font-size:10px">CASE STUDY</p>
            <h4>Leveraged Customer Feedback for Improved Services</h4>
            <p>Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety...
      ...
      <div class="col-xs-18 col-sm-6 col-md-4">
        <div class="thumbnail">
          <img src="assets/images/g5.png" style="height:200px;width:100%;">
          <div class="caption">
            <p style="color:#DC1010;font-size:10px">CASE STUDY</p>
            <h4>Leveraged Customer Feedback for Improved Services</h4>
            <p>Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety...
      ...
      <div class="col-xs-18 col-sm-6 col-md-4">
        <div class="thumbnail">
          <img src="assets/images/g6.png" style="height:200px;width:100%;">
          <div class="caption">
            <p style="color:#DC1010;font-size:10px">CASE STUDY</p>
            <h4>Leveraged Customer Feedback for Improved Services</h4>
            <p>Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety...
