...
<?php include('header.php'); ?>
  ...
  #181015 url(assets/images/banner18.webp) no-repeat;background-size: cover;">
    <div class="container">
      <div class="heading">
    ...
    <div class="container" id="spacing">
        ...
        <div class="row">
          ...
          <div class="col-xs-18 col-sm-6 col-md-4">
            <div class="thumbnail">
              <img src="assets/images/imm7.webp" />
              <div class="caption">
          ...
          <div class="col-xs-18 col-sm-6 col-md-4">
            <div class="thumbnail">
              <img src="assets/images/imm9.webp" />
              <div class="caption">
                <p style="color:#DC1010;font-size:12px"><b style="color:#DC1010">TIPS</b></p>
                <p style="font-size:12px"><b style="color:black">May 16 2023</b></p>
                <h4>Leveraged Customer Feedback for Improved Services</h4>
          ...
          <div class="col-xs-18 col-sm-6 col-md-4">
            <div class="thumbnail">
              <img src="assets/images/imm8.webp" />
              <div class="caption">
                <p style="color:#DC1010;font-size:12px"><b style="color:#DC1010">TIPS</b></p>
                <p style="font-size:12px"><b style="color:black">May 16 2023</b></p>
                <h4>Leveraged Customer Feedback for Improved Services</h4>
          ...
          <div class="col-xs-18 col-sm-6 col-md-4">
            <div class="thumbnail">
              <img src="assets/images/imm10.webp" />
              <div class="caption">
                <p style="color:#DC1010;font-size:12px"><b style="color:#DC1010">TIPS</b></p>
                <p style="font-size:12px"><b style="color:black">May 16 2023</b></p>
                <h4>Leveraged Customer Feedback for Improved Services</h4>
          ...
          <div class="col-xs-18 col-sm-6 col-md-4">
            <div class="thumbnail">
              <img src="assets/images/imm11.webp" />
              <div class="caption">
                <p style="color:#DC1010;font-size:12px"><b style="color:#DC1010">TIPS</b></p>
                <p style="font-size:12px"><b style="color:black">May 16 2023</b></p>
                <h4>Leveraged Customer Feedback for Improved Services</h4>
